...
impl<T> RmsEnvDetector<T> where T: Float {
...
impl<T> Processor<T> for RmsEnvDetector<T> where T: Float {
...
mod tests {
  ...
  #[test]
  fn new() {
    let detector = RmsEnvDetector::<f32>::new();
